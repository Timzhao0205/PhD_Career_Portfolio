...
- `evidence/blind/MANIFEST.json`
- `evidence/blind/POOL_1.json`
- `evidence/blind/POOL_2.json`
- `evidence/blind/POOL_3.json`
- root policy files

Do not read `sources`, any old/new output, any prior-stage output, or any prior
ranking. Do not web search in this blind stage.
