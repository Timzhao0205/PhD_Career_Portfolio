...
All file-modification timestamps under `01/` currently read
...
- **Important disambiguation**: this folder is *not* the infrastructure
  ...
  `AGENTS.md`) live at the `01/` root, use this mission's own
...
## Group H — Parent root memory (`../CLAUDE.md`, `../01_Folder_Info.md`)
