...
- `../01_Folder_Info.md`: *"Demonstrated in-situ (2023 Letters) → calibrated spinning-current readout (02, HSX install Aug 2026) → calibrated 2–3 axis vector probe + second HSX campaign (03, RSI paper, ~Mar 2027)."*
